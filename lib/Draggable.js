...
export default class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  render(): ReactElement<any> {
    ...
    return (
      <DraggableCore {...this.props} onStart={this.onDragStart} onDrag={this.onDrag} onStop={this.onDragStop} onKeyUp={this.onKeyUp} onKeyDown={this.onKeyDown} >
        {
