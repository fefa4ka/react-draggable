  ...
  function Draggable(props /*: DraggableProps*/) {
    ...
    _this.onKeyMove = function (e) {
      ...
      if (e && (e.keyCode === 37 || e.keyCode === 38 || e.keyCode === 39 || e.keyCode === 40)) {
        ...
        var _x = _x4;
        var _y = _y4;
        (0, _log2.default)('onKeyUp', e.keyCode);
        (0, _log2.default)('onKeyUp', e.keyCode, _this.state);
        switch (e.keyCode) {
          // 左
          case 37:
            _x -= 1;
